...
type ExerciseApiServicer interface { 
	GetExerciseRecords(int64, string, string) (interface{}, error)
	PostExerciseRecord(int64, ExerciseRecord) (interface{}, error)
}
...
type FoodApiServicer interface { 
	GetFoodRecords(int64, string, string) (interface{}, error)
	PostFoodRecord(int64, FoodRecord) (interface{}, error)
}
...
type GoalsApiServicer interface { 
	GetCalorieGoal(int64) (interface{}, error)
	PutCalorieGoal(int64, CalorieGoal) (interface{}, error)
}
...
type MetricsApiServicer interface { 
	GetMetrics(int64) (interface{}, error)
	PutMetrics(int64, BodyMetrics) (interface{}, error)
}
